...
insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/7iViWi7.jpg', 'Harmon', 'Tulloch', '601-879-0650', '1956-12-11', '1 Pond Point', 'This client is blind and needs assistance with daily tasks such as grocery shopping and navigating their home. They do not have any pets.', 'Takes medication for diabetes, high blood pressure and cholesterol, also has a history of kidney disease and had a kidney transplant.');
