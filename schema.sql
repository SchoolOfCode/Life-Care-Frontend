...
insert into carers (avatar, first_name, last_name, number, email) values ('https://i.imgur.com/lCRUy5D.jpg', 'Seana', 'Skittle', '07738 244972', 'seana.s@lifecare.com'); 

insert into carers (avatar, first_name, last_name, number, email) values ('https://i.imgur.com/IyOqe4z.jpg', 'Nikolos', 'Coady', '07843 986242', 'ncoady1@lifecare.com');

insert into carers (avatar, first_name, last_name, number, email) values ('https://i.imgur.com/TLXNWH3.jpg', 'Anastassia', 'Beavington', '07763 566995', 'anastassia.b@lifecare.com');


-- patients insert

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/XBIvJRO.jpg', 'Rollin', 'Laflin', '0161 496 0525', '1952-10-25', '50 Gale Lane', 'This client is in the early stages of dementia and requires assistance with medication management and meal preparation. They have a small dog for companionship.', 'Takes medication for high blood pressure and arthritis. Has issues with hearing and vision, also has a history of stroke.');

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/1OQe6Fs.jpg', 'Pate', 'McKeown', '0115 496 0591', '1956-08-22', '6a Kenthouse Road', 'This client has recently had a hip replacement and needs help with mobility and physical therapy exercises. They do not have any pets.', 'Has anxiety and depression, does not take any medication but receiving therapy.');

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/IhYZlOq.jpg', 'Jolyn', 'Woodyeare', '0118 496 0335', '1958-02-14', '72 Ridgeview Avenue', 'This client has a chronic heart condition and needs assistance with monitoring their vital signs and managing their diet. They have a cat for companionship.', 'Takes medication for high blood pressure and cholesterol, also has a history of heart disease and had a bypass surgery, and has a pacemaker implanted.');

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/7iViWi7.jpg', 'Harmon', 'Tulloch', '0116 496 0528', '1956-12-11', '1 Pond Point', 'This client is blind and needs assistance with daily tasks such as grocery shopping and navigating their home. They do not have any pets.', 'Takes medication for diabetes, high blood pressure and cholesterol, also has a history of kidney disease and had a kidney transplant.');

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/mMj1yo4.jpg', 'Natalya', 'D''Cruze', '0115 496 0980', '1953-03-16', '36 Vidon Pass', 'This client has limited mobility due to a stroke and requires assistance with dressing, bathing, and using the restroom. They have a small dog for companionship.', 'Takes medication for high blood pressure, arthritis and osteoporosis. Has issues with hearing and vision, also has a history of stroke.');

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/0IQnCWP.jpg', 'Omero', 'McMonies', '0131 496 0997', '1957-09-17', '68 Illingworth Way', 'This client is dealing with the early stages of Parkinson''s Disease and needs assistance with mobility and maintaining their independence. They do not have any pets.', 'Takes medication for high blood pressure and has issues with arthritis.');

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/7Jhrp75.jpg', 'Miriam', 'Cheves', '0115 496 0960', '1954-03-27', '18 North Terrace', 'This client is recovering from a fall and needs assistance with physical therapy and managing their medications. They have a cat for companionship.', 'Takes medication for high blood pressure, has issues with vision, also a history of glaucoma and had a cataract surgery.');

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/C1x7r7L.jpg', 'Portie', 'Greatbatch', '0113 496 0521', '1956-10-18', 'Flat 10a Hanson Pass', 'This client has advanced arthritis and needs assistance with managing their pain and helping them with daily tasks. They do not have any pets.', 'Has anxiety and depression, has a history of PTSD and receiving therapy for it, also takes medication for sleep disorder.');

insert into patients (avatar, first_name, last_name, number, dob, address, overview, medical_history) values ('https://i.imgur.com/8E1wVXg.jpg', 'Marjorie', 'Engledow', '0131 496 0334', '1954-03-27', '3 Coleman Point', 'This client has a chronic lung disease and needs assistance with managing their oxygen levels and monitoring their breathing. They do not have any pets.', 'Takes medication for high blood pressure, has issues with arthritis, also has a history of gout.');
